          ...
          <table border="0">
            ...
            <table class="table table-striped table-bordered">
                  ...
                  <?php
                   ...
                   $total_pages_sql = "SELECT COUNT(*) FROM `face_keamanan` JOIN employee ON face_keamanan.nama=employee.nama_pegawai WHERE status='melanggar' ";
                   ...
                   while ($row = $query->fetch_assoc()) {
                            ...
                            echo '<td width=250>';
                            echo '<img style="width:50%;height:10%" id="'.$no++.'" data-toggle="modal" data-target="#myModal" src="hasil_keamanan/'. $row['nama'] . ''. $row['waktu'] . '.jpg" alt="'. $row['nama'] . '" />';
                            echo '</td>';
                            echo '</tr>';
                   }
            ...
            <center>
              <a target="_blank" href="export_keamanan.php">EXPORT KE EXCEL</a>
            </center>
                  <ul class="pagination">
